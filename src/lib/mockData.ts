...
const CITIES: CityDef[] = [
  city("Seattle", "WA", "98118", 47.548, -122.269, 420, 2400, 0.0088),
  city("Portland", "OR", "97202", 45.484, -122.628, 340, 2000, 0.0105),
  city("San Francisco", "CA", "94112", 37.72, -122.442, 750, 3400, 0.0074),
  city("Oakland", "CA", "94601", 37.774, -122.218, 520, 2600, 0.0082),
  city("Los Angeles", "CA", "90011", 34.007, -118.258, 520, 2500, 0.0072),
  city("San Diego", "CA", "92113", 32.699, -117.096, 480, 2400, 0.0073),
  city("Sacramento", "CA", "95823", 38.482, -121.446, 270, 1800, 0.0081),
  city("Fresno", "CA", "93706", 36.706, -119.793, 210, 1400, 0.0082),
  city("Las Vegas", "NV", "89101", 36.175, -115.137, 250, 1600, 0.0055),
  city("Phoenix", "AZ", "85008", 33.449, -112.03, 260, 1650, 0.0051),
  city("Tucson", "AZ", "85713", 32.191, -110.926, 190, 1350, 0.0085),
  city("Denver", "CO", "80219", 39.699, -105.019, 340, 2100, 0.0051),
  city("Colorado Springs", "CO", "80910", 38.816, -104.76, 260, 1650, 0.0044),
  city("Salt Lake City", "UT", "84115", 40.723, -111.888, 300, 1750, 0.0055),
  city("Boise", "ID", "83705", 43.583, -116.243, 270, 1600, 0.0053),
  city("Albuquerque", "NM", "87105", 35.038, -106.647, 190, 1300, 0.0098),
  city("Chicago", "IL", "60629", 41.776, -87.706, 220, 1900, 0.0184),
  city("Minneapolis", "MN", "55407", 44.925, -93.262, 270, 1800, 0.0122),
  city("Milwaukee", "WI", "53215", 43.007, -87.94, 160, 1350, 0.0217),
  city("Detroit", "MI", "48210", 42.339, -83.108, 90, 1100, 0.0283),
  city("Grand Rapids", "MI", "49507", 42.938, -85.66, 190, 1350, 0.014),
  city("Indianapolis", "IN", "46201", 39.774, -86.135, 155, 1300, 0.0099),
  city("Columbus", "OH", "43206", 39.938, -82.987, 175, 1400, 0.0162),
  city("Cleveland", "OH", "44109", 41.459, -81.699, 110, 1150, 0.021),
  city("Cincinnati", "OH", "45204", 39.108, -84.567, 145, 1250, 0.016),
  city("Kansas City", "MO", "64127", 39.089, -94.534, 160, 1300, 0.0118),
  city("St. Louis", "MO", "63111", 38.56, -90.264, 130, 1200, 0.0105),
  city("Omaha", "NE", "68107", 41.222, -95.958, 175, 1350, 0.0185),
  city("Des Moines", "IA", "50315", 41.564, -93.622, 165, 1300, 0.0185),
  city("Dallas", "TX", "75217", 32.716, -96.686, 210, 1600, 0.0177),
  city("Fort Worth", "TX", "76104", 32.736, -97.321, 185, 1500, 0.0186),
  city("Houston", "TX", "77033", 29.688, -95.348, 165, 1500, 0.0177),
  city("Austin", "TX", "78741", 30.23, -97.712, 320, 1900, 0.0162),
  city("San Antonio", "TX", "78211", 29.383, -98.549, 170, 1400, 0.0185),
  city("Oklahoma City", "OK", "73129", 35.408, -97.516, 140, 1200, 0.0095),
  city("Tulsa", "OK", "74107", 36.121, -95.998, 130, 1150, 0.0102),
  city("Little Rock", "AR", "72204", 34.719, -92.348, 140, 1150, 0.0066),
  city("Atlanta", "GA", "30310", 33.734, -84.417, 250, 1700, 0.0094),
  city("Nashville", "TN", "37115", 36.238, -86.706, 270, 1750, 0.0063),
  city("Memphis", "TN", "38116", 35.037, -90.007, 130, 1150, 0.0124),
  city("Charlotte", "NC", "28208", 35.222, -80.883, 230, 1650, 0.0086),
  city("Raleigh", "NC", "27610", 35.759, -78.591, 250, 1700, 0.0083),
  city("Columbia", "SC", "29203", 34.07, -80.977, 165, 1300, 0.0066),
  city("Jacksonville", "FL", "32209", 30.373, -81.687, 210, 1600, 0.0085),
  city("Tampa", "FL", "33605", 27.964, -82.43, 270, 1750, 0.0086),
  city("Orlando", "FL", "32805", 28.531, -81.421, 260, 1700, 0.0089),
  city("Miami", "FL", "33142", 25.813, -80.238, 380, 2300, 0.009),
  city("Birmingham", "AL", "35211", 33.484, -86.879, 130, 1100, 0.0042),
  city("New Orleans", "LA", "70126", 30.011, -89.986, 210, 1500, 0.0078),
  city("New York", "NY", "11226", 40.646, -73.956, 520, 2600, 0.0086),
  city("Philadelphia", "PA", "19143", 39.947, -75.229, 165, 1550, 0.0096),
  city("Pittsburgh", "PA", "15210", 40.415, -79.986, 155, 1250, 0.0179),
  city("Baltimore", "MD", "21215", 39.336, -76.673, 160, 1500, 0.015),
  city("Washington", "DC", "20019", 38.889, -76.941, 380, 2300, 0.0056),
  city("Boston", "MA", "02125", 42.313, -71.057, 480, 2600, 0.0072),
